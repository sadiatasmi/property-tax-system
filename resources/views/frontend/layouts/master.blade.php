    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          @else
          <li><a class="nav-link scrollto" href="{{ route('profile') }}">Holding</a></li>
          <li><a class="nav-link scrollto" href="{{ route('tax.pay_list') }}">Tax Pay</a></li>

          <li><a class="nav-link scrollto" href="{{ route('payment.history') }}">Payment History</a></li>
          <li>
